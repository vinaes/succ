...
// ============================================================================
// Query Classification (zero LLM cost)
// ============================================================================
 ...
 *
 * - identifier: PascalCase, snake_case, dotNotation, contains () → alpha=0.3 (boost BM25)
 * - natural_language: starts with how/what/why/when, >5 words → alpha=0.7 (boost vector)
...
export function classifyQuery(query: string): { type: QueryType; alpha: number } {
  ...
  const isLongQuery = words.length > 5;
