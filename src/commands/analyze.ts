...
const RECURSIVE_ANALYSIS_THRESHOLD = 10_000;
/** Max chars per batch for chunk analysis */
const CHUNK_BATCH_SIZE = 8_000;
/** Max concurrent chunk analysis calls */
const CHUNK_ANALYSIS_CONCURRENCY = 3;

// formatSymbolMap and batchChunks imported from ./analyze-helpers.js
 ...
 */
async function analyzeFileRecursive(
  fileContent: string,
  absolutePath: string,
  relativePath: string,
  fileName: string,
