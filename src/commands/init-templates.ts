...
_Files are automatically added here when analyzed with \`succ_index(action="analyze")\` or \`succ analyze\`._
...
export function getPrdMocTemplate(): string {
  return `---
description: "MOC - PRD pipeline output (generated specs, tasks, execution logs)"
type: moc
relevance: medium
---
...
Product Requirements Documents generated by the PRD pipeline.

## Generated PRDs

_PRDs are automatically created here by \`succ prd generate\` and \`succ_prd(action="generate")\`._
...
export function getCommunicationMocTemplate(): string {
  return `---
description: "MOC - Communication style tracking and preferences"
type: moc
relevance: low
---
...
User communication style tracking. Updated by the succ-style-tracker agent.
